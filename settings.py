...
class SettingsManager:
    def __init__(self):
        ...
        self._definitions = {
            ...
            "lyrics.display.word_sync_transition_ms": Setting("Word-Sync Transition", int, 0, False, "Lyrics", "Line transition delay (ms). 0=instant, 70=smooth.", "slider", min_val=0, max_val=300),
