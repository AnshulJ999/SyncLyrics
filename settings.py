...
class SettingsManager:
    def __init__(self):
        ...
        self._definitions = {
            ...
            "ui.keep_screen_awake": Setting("Keep Screen Awake", str, "playback", False, "UI", "Keep the display awake while lyrics are shown - always, only during playback, or off (requires HTTPS)", "select", options=["always", "playback", "off"]),
